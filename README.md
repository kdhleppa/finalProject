...
>프로젝트 소개
<h3>파이널 프로젝트로서 캠핑장예약과 함께 간단한 장비 렌탈이 가능한 사이트를 만들고자 했습니다.</h3>
...
담당 구현 기능 : 게시판, 댓글, Quill, CLOVA CHATBOT API, 1:1 문의
...
캠핑장 상세 페이지에서는 캠핑장에 대한 정보를 제공합니다.

위시리스트에 캠핑장 추가, 1:1 문의를 할 수 있고, 마쉬멜로우 아이콘으로 별점을 매길 수 있습니다.

하단에서 달력을 통해 숙박날짜를 먼저 선택하고, 이에 숙박가능한 사이트를 고를 수 있도록 구현하였습니다.

예약 페이지로 넘어가면 예약자 정보를 입력하고, 그 후에 여러 결제 수단을 선택하여 금액을 지불하도록 하였습니다.

예약이 완료되면 예약 정보가 데이터 베이스에 저장되며, 결제 상태도 함께 저장됩니다.
...
- 규연
<img src="https://github.com/kdhleppa/finalProject/assets/139316047/4708217f-9f06-4d52-95f5-f97f00c781f0">&nbsp;&nbsp;
